    ...
    <div className=" bg-[#F3F5FA] sm:mt-32 mt-2 xl:mt-48 pb-28">
      ...
      <div className="px-[50px]">
        <div className="flex flex-wrap justify-center gap-4 pt-16 border-b-2 pb-12 xl:flex-nowrap">
          <div className="flex flex-col items-center border-0 md:border-l-2 pl-4">
            ...
            <h5 className="text-xl font-bold mt-2 cursor-default">
              حمل و نقل رایگان
            </h5>
            <p className="text-gray-400 mt-2 cursor-default">
              ارسال رایگان کلیه محصولات به سراسر کشور
            </p>
          </div>
          <div className="flex flex-col items-center border-0 md:border-l-2 pl-4">
            <span className="text-red-600 text-5xl">
            ...
            <p className="text-gray-400 mt-2 cursor-default">
              ضمانت بازگشت وجه تا ۳۰ روز پس از خرید محصول
            </p>
          </div>
          <div className="flex flex-col items-center border-0 md:border-l-2 pl-4">
            <span className="text-red-600 text-5xl">
            ...
            <p className="text-gray-400 mt-2 cursor-default">
              پرداخت توسط کلیه کارتهای عضو شبکه شتاب
            </p>
          </div>
          <div className="flex flex-col items-center">
            ...
            <h5 className="text-xl font-bold mt-2 cursor-default">
              پشتبانی آنلاین ۲۴ ساعته
            </h5>
            <p className="text-gray-400 mt-2 cursor-default">
              شماره تماس پشتیبانی :{" "}
              <span className="text-red-600 font-semibold">013 123 456 78</span>
            </p>
          </div>
        </div>
      </div>
      ...
      <div>
        <div className="flex justify-center items-center mt-28">
          <h2 className="lg:text-4xl md:text-2xl text-xl font-bold lg:font-normal cursor-default">
            نظرات <span className="text-red-600">مشتریان</span>
          </h2>
        </div>
        <div className="flex justify-center items-center gap-2 mt-1.5">
          <span className="text-red-600 font-bold cursor-default">4.8</span>
          <span className="flex text-sm text-yellow-500 cursor-default">
            <MdStar />
            <MdStar />
            <MdStar />
            <MdStar />
