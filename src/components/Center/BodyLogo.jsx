    ...
    <div className="w-[84%] mx-auto mt-20">
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center gap-20 py-20 border-y-2 mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-20 items-center mx-auto">
          ...
          >
            <ImageWithLoader
              className="lg:w-[140px] h-[30px] sm:w-[80px] w-[140px] lg:h-[40px]"
              src={Logo1}
              alt="AMD Logo"
            />
          </a>
          <a href="https://www.corsair.com/us/en?srsltid=AfmBOoodSMLiSZUH0uTE8BRXZcvZDyLlBCg2xC8g8oy7CLg6hkOmp-IP">
            <ImageWithLoader
              className="lg:w-[140px] h-[40px] sm:h-[30px] sm:w-[100px] w-[140px] lg:h-[40px]"
              src={Logo2}
            />
          </a>
          ...
          <a href="https://www.nvidia.com/en-us/drivers/">
            <ImageWithLoader
              className="lg:w-[140px] h-[30px] sm:w-[100px] w-[140px] lg:h-[40px]"
              src={Logo4}
            />
          </a>
      ...
      <div className="flex flex-col md:flex-row gap-6 mt-24 mx-auto justify-center">
        <div className="relative mx-auto">
          ...
          <Link onClick={handleClick}>
            <button className="text-black  bg-white rounded-md w-[91px] h-[36px] justify-center text-xs font-medium left-5 bottom-5 absolute hover:bg-red-600 hover:text-white duration-500 hidden lg:flex items-center group">
              مشاهده کالا{" "}
              <IoMdArrowDropleft className="text-base text-red-600 group-hover:text-black" />{" "}
            </button>
          </Link>
        </div>
        <div className="relative mx-auto">
        ...
        <div className="relative mx-auto">
          ...
          <div className="absolute top-10 right-8 text-white text-4xl  md:text-sm xl:text-3xl font-bold flex flex-col">
            ...
            <div className="mt-10 text-2xl md:text-lg lg:text-2xl w-[220px] md:w-[120px] xl:w-[180px] 2xl:w-[260px]">
              هدست های حرفه ای E910
            </div>
          </div>
          <Link onClick={handleClick}>
            <button className="text-black  bg-white rounded-md w-[91px] h-[36px] justify-center text-xs font-medium left-5 bottom-5 absolute hover:bg-red-600 hover:text-white duration-500 hidden lg:flex items-center group">
