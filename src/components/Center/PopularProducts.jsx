...
const PopularProducts = () => {
  return (
    <div
      className="h-[100vh] mt-16 lg:mt-20 xl:mt-52 w-[92%] m-auto"
      id="PopularProducts"
    >
      {/* Top Title */}
      ...
      <div className="flex items-end justify-between mt-10 gap-10">
        ...
        <div className="relative w-[330px] h-[527px] hidden xl:flex">
          ...
          <div className="absolute text-white top-5 right-14 flex flex-col justify-center">
            <h6 className="text-lg font-bold text-[#FAB460] mr-4 mt-10 cursor-default">
              بهترین کیس کامپیوتر
            </h6>
            <h4 className=" text-2xl 2xl:text-4xl mt-20 font-semibold cursor-default">
              اسمبل شده مطابق با سلیقه شما
            </h4>
          </div>
        </div>
      </div>
