  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center sm:justify-around gap-0 sm:gap-20">
        ...
        <div className="-mt-16">
          <ImageWithLoader
            className="xl:w-[100%] lg:w-[450px] md:w-[350px] sm:w-[300px] w-[240px] hidden sm:flex"
            src={ControlImg}
            alt="Control Image"
          />
        </div>
      ...
      <div>
        <div className="flex justify-center mt-32 relative">
          <ImageWithLoader
            className="w-0 sm:w-[1410px] h-[270px] rounded-xl hidden md:flex"
            src={Img2}
            alt="Background"
          />
          ...
          <div className="absolute inset-0 flex justify-center gap-[120px] sm:gap-[160px] md:gap-[240px] lg:gap-[360px] xl:gap-[500px] 2xl:gap-[600px] items-center px-10">
            ...
            <div className="text-white flex flex-col xl:mr-40 2xl:mr-56">
              <h6 className="lg:text-xl  md:text-md text-xs sm:text-sm mb-2 md:mr-0 sm:mr-16 mr-4 cursor-default">
                مانیتور نسل جدید
              </h6>
              <h3 className="lg:text-3xl md:text-xl  text-sm sm:text-lg font-bold md:mr-0 sm:mr-16 mr-4 cursor-default">
                راگ استریکس
              </h3>
              <h3 className="lg:text-3xl md:text-xl  text-sm sm:text-lg font-bold md:mr-0 sm:mr-16 mr-4 cursor-default">
                XG39UK
            ...
            <div>
              <ImageWithLoader
                src={HomeLogo}
                alt="logo"
                className="lg:w-[370px] sm:w-[260px] w-[200px] lg:h-[65px] pl-5"
              />
            </div>
          </div>
        </div>
