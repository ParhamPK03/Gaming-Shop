  ...
  return (
    <div>
      ...
      <div className="lg:flex hidden gap-11 justify-center text-[17px] font-normal mt-4">
        <Link to="/headset" className="hover:text-red-600 duration-500">
          هدست
        </Link>
        <Link to="/keyboards" className="hover:text-red-600 duration-500">
          انواع کیبوردها
        </Link>
        <Link to="/mouse" className="hover:text-red-600 duration-500">
          ماوس
        </Link>
        <Link to="/joystick" className="hover:text-red-600 duration-500">
          جوی استیک
        </Link>
        <Link to="/monitor" className="hover:text-red-600 duration-500">
          مانیتور
        </Link>
        <Link to="/microphone" className="hover:text-red-600 duration-500">
          میکروفون
        </Link>
        <Link onClick={handleClick} className="hover:text-red-600 duration-500">
          انواع پاور
        </Link>
        <Link onClick={handleClick} className="hover:text-red-600 duration-500">
          انواع لوازم جانبی
        </Link>
        <Link to="/auction" className="hover:text-red-600 duration-500">
          حراج
        </Link>
      </div>
