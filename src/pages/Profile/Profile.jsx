...
const Profile = () => {
  ...
  return (
    <div className="bg-[#222222] overflow-hidden  font-iran">
      <div>
        <NavbarTop />
        <NavbarMain />
      </div>
      ...
      <div className="w-[86%] mx-auto text-white flex md:flex-row items-center flex-col mt-8 md:mt-20 gap-5">
        <div className="md:w-1/4 w-2/4 border-[1px] border-white/70 rounded-2xl py-5">
          ...
          <div className="flex flex-col items-center justify-center mt-8 text-center">
            <div className="flex flex-col items-center justify-center mt-8 text-center">
              <h4 className="bg-red-600 rounded-full 2xl:w-[260px] lg:w-[180px] md:w-[140px] sm:w-[200px] w-[160px] h-[34px]">
                اطلاعات کاربری
              </h4>
              <ul className="leading-9 text-red-600 font-medium md:text-xs sm:text-sm text-xs lg:text-sm items-center">
                <li
                  onClick={MyOrders}
                  className="hover:bg-slate-50 cursor-pointer mt-4 border-[1px] border-white rounded-full duration-300 2xl:w-[260px] sm:w-[200px] w-[160px] lg:w-[180px] md:w-[140px] h-[34px] flex items-center justify-center gap-2"
                >
                  <MdOutlineBorderColor />
                  <span>سفارش های من</span>
                </li>
                <Link to="/shoppingCart">
                  <li className="hover:bg-slate-50 cursor-pointer mt-4 border-[1px] border-white rounded-full duration-300 2xl:w-[260px] sm:w-[200px] w-[160px] lg:w-[180px] md:w-[140px] h-[34px] flex items-center justify-center gap-2">
                    <IoLocation />
                    سبد خرید من
                  </li>
                </Link>
