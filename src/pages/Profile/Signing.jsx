...
const Signing = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-gray-700 w-[100%] to-[#222222] h-screen font-iran">
      <form onSubmit={handleSubmit}>
        <div>
          <div className="flex justify-center">
            <Link to="/">
              <img
                className="mt-20 sm:w-40 w-32 cursor-pointer"
                src={Logo}
                alt="Logo"
              />
            </Link>
          ...
          <div className="bg-slate-400 w-[300px] sm:w-[400px] h-full p-4 mx-auto mt-10 rounded-xl">
            <h5 className="flex justify-center pt-5 text-base sm:text-xl font-bold text-white mt-8">
              ورود به حساب کاربری
            </h5>
            ...
            <div className="mr-6 mt-5">
              ...
              />
              <label className="text-white mr-2 sm:text-sm text-xs">
                مرا به خاطر بسپار
              </label>
            </div>
            <div className="mt-3 mr-6">
              <a className="cursor-pointer no-underline text-white text-xs sm:text-sm">
            ...
            <div className="mt-2 flex items-center">
              <Link
                to="/signup"
                className="no-underline mr-2 text-white cursor-pointer text-xs sm:text-sm"
              >
                کاربر جدید هستید؟{" "}
