      ...
      <form onSubmit={handleSubmit}>
        <div>
          ...
          <div className="bg-slate-400 w-[300px] sm:w-[400px] h-full p-4 mx-auto mt-10 rounded-xl">
            <h5 className="flex justify-center pt-5 sm:text-2xl text-lg font-bold text-white mt-8">
              ثبت نام
            </h5>
            ...
            <div className="mt-2 flex items-center">
              <Link
                to="/signing"
                className="no-underline mr-2 text-white text-xs sm:text-sm cursor-pointer"
              >
