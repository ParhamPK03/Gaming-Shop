          ...
          <div className="mt-10">
            ...
            <div className="items-center flex flex-col">
              ...
              <button
                ...
                className="mt-4 bg-red-600 hover:bg-green-500 duration-500 text-white py-2 px-4 rounded"
              >
                ارسال
              </button>
            </div>
        ...
        <div className="2xl:w-[300px] lg:w-[500px] md:w-[350px] w-[300px] h-[300px] border-[1px] shadow-sm shadow-red-600 border-red-600 rounded-md items-center flex flex-col justify-center gap-y-5 2xl:-mt-48">
          ...
          <div>
            <Link to="/ShoppingCart">
              <button className="rounded-ful text-red-600 w-[180px] h-[36px] border-2 border-red-600 rounded-full hover:bg-red-100 duration-500">
                بازگشت به سبد خرید
              </button>
            </Link>
          </div>
